# Course Checker Info [![Moodle Plugin CI](https://github.com/ffhs/moodle-block_course_checker_info/actions/workflows/moodle-plugin-ci.yml/badge.svg)](https://github.com/ffhs/moodle-block_course_checker_info/actions/workflows/moodle-plugin-ci.yml)
